  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-primary-shift': 'var(--gradient-primary-shift)',
      ...
      boxShadow: {
        ...
        'colored': '0 10px 30px -5px',
        'bold': '0 15px 35px -5px hsl(var(--primary) / 0.3)',
      },
      fontFamily: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "var(--shadow-glow-sm)", transform: "scale(1)" },
          "50%": { boxShadow: "var(--shadow-glow-lg)", transform: "scale(1.02)" },
        },
        "rainbow-border": {
          "0%, 100%": { borderColor: "hsl(220, 90%, 56%)" },
          "33%": { borderColor: "hsl(280, 85%, 60%)" },
          "66%": { borderColor: "hsl(320, 90%, 60%)" },
        },
        "bounce-gentle": {
