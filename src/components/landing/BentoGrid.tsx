      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[280px]">
          {items.map((feature, index) => (
            ...
            >
              <motion.div
                className={`relative h-full rounded-3xl p-8 overflow-hidden bg-gradient-to-br ${feature.gradient} border border-border/50 backdrop-blur-sm group cursor-pointer`}
